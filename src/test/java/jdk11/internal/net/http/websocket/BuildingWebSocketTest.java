...
import static jdk11.internal.net.http.websocket.TestSupport.assertThrows;
...
public class BuildingWebSocketTest {
    ...
    public void nullArguments() {
        ...
        TestSupport.assertThrows(NullPointerException.class,
    ...
    void illegalURI(URI uri) {
        ...
        TestSupport.assertCompletesExceptionally(IllegalArgumentException.class,
    ...
    public void illegalHeaders() {
        ...
        headers.forEach(h -> TestSupport.assertCompletesExceptionally(IllegalArgumentException.class, f.apply(h)));
    }

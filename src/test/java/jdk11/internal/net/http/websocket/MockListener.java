...
public class MockListener implements WebSocket.Listener {
    ...
    public CompletionStage<?> onBinary(WebSocket webSocket,
        ...
        invocations.add(new OnBinary(webSocket, TestSupport.fullCopy(message), part));
    ...
    public CompletionStage<?> onPing(WebSocket webSocket, ByteBuffer message) {
        ...
        invocations.add(new OnPing(webSocket, TestSupport.fullCopy(message)));
    ...
    public CompletionStage<?> onPong(WebSocket webSocket, ByteBuffer message) {
        ...
        invocations.add(new OnPong(webSocket, TestSupport.fullCopy(message)));

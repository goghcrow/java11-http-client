...
public class HeaderTableTest {
    ...
    private final Random rnd = TestHelper.newRandom();
    ...
    public void negativeMaximumSize() {
        ...
        IllegalArgumentException e =
                TestHelper.assertVoidThrows(IllegalArgumentException.class,
                        () -> new HeaderTable(0, HPACK.getLogger()).setMaxSize(maxSize));
        TestHelper.assertExceptionMessageContains(e, "maxSize");
    }
    ...
    public void negativeIndex() {
        ...
        IndexOutOfBoundsException e =
                TestHelper.assertVoidThrows(IndexOutOfBoundsException.class,
                        () -> new HeaderTable(0, HPACK.getLogger()).get(idx));
        TestHelper.assertExceptionMessageContains(e, "index");
    }

    @Test
    public void zeroIndex() {
        IndexOutOfBoundsException e =
                TestHelper.assertThrows(IndexOutOfBoundsException.class,
    ...
    public void entryPutAfterStaticArea() {
        ...
        TestHelper.assertThrows(IndexOutOfBoundsException.class, () -> table.get(idx));

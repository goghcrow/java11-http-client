...
public final class DecoderTest {
    ...
    public void incorrectSizeUpdate() {
        ...
        {
            Decoder d = new Decoder(4096);
            TestHelper.assertVoidThrows(IOException.class,
    ...
    public void corruptedHeaderBlockInteger() {
        ...
        IOException e = TestHelper.assertVoidThrows(IOException.class,
                () -> d.decode(data, true, nopCallback()));
        TestHelper.assertExceptionMessageContains(e, "Unexpected end of header block");
    }
    ...
    public void headerBlockIntegerNoOverflow() {
        ...
        TestHelper.assertExceptionMessageContains(e.getCause(), "index=2147483647");
    }
    ...
    public void headerBlockIntegerOverflow() {
        ...
        TestHelper.assertExceptionMessageContains(e, "Integer overflow");
    }
    ...
    public void corruptedHeaderBlockHuffmanStringEOS() {
        ...
        TestHelper.assertExceptionMessageContains(e, "Encountered EOS");
    }
    ...
    public void corruptedHeaderBlockHuffmanStringLongPadding1() {
        ...
        TestHelper.assertExceptionMessageContains(e, "Padding is too long", "len=9");
    }
    ...
    public void corruptedHeaderBlockHuffmanStringLongPadding2() {
        ...
        TestHelper.assertVoidDoesNotThrow(() -> d.decode(data, true, nopCallback()));
    }
    ...
    public void corruptedHeaderBlockHuffmanStringNotEOSPadding() {
        ...
        TestHelper.assertExceptionMessageContains(e, "Not a EOS prefix");
    }

    @Test
    public void argsTestBiConsumerIsNull() {
        Decoder decoder = new Decoder(4096);
        TestHelper.assertVoidThrows(NullPointerException.class,

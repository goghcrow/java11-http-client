...
public class HttpRequestBuilderTest {
    ...
    private static void realmain(String[] args) throws Exception {
        ...
        builder = test3("DELETE", builder, builder::DELETE,null);
        ...
        builder = test3("DELETE", builder, builder::DELETE,
                        NullPointerException.class);
...
//        builder.build();
        ...
        method("newBuilder(TEST_URI).POST(fromString(\"\")).GET().build().method() == GET",
               () -> HttpRequest.newBuilder(TEST_URI).POST(HttpRequest.BodyPublishers.ofString("")).GET(),
               "GET");

        method("newBuilder(TEST_URI).PUT(fromString(\"\")).GET().build().method() == GET",
               () -> HttpRequest.newBuilder(TEST_URI).PUT(HttpRequest.BodyPublishers.ofString("")).GET(),
               "GET");
        ...
        method("newBuilder(TEST_URI).POST(fromString(\"\")).build().method() == POST",
               () -> HttpRequest.newBuilder(TEST_URI).POST(HttpRequest.BodyPublishers.ofString("")),
               "POST");

        method("newBuilder(TEST_URI).PUT(fromString(\"\")).build().method() == PUT",
               () -> HttpRequest.newBuilder(TEST_URI).PUT(HttpRequest.BodyPublishers.ofString("")),
               "PUT");
        ...
        method("newBuilder(TEST_URI).GET().POST(fromString(\"\")).build().method() == POST",
               () -> HttpRequest.newBuilder(TEST_URI).GET().POST(HttpRequest.BodyPublishers.ofString("")),
               "POST");

        method("newBuilder(TEST_URI).GET().PUT(fromString(\"\")).build().method() == PUT",
               () -> HttpRequest.newBuilder(TEST_URI).GET().PUT(HttpRequest.BodyPublishers.ofString("")),
               "PUT");
    ...
    @SafeVarargs
    static <R, P> R test3(String name, R receiver, Supplier<R> m,
                          Class<? extends Exception> ...ex) {

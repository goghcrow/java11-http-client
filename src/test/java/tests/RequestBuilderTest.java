...
import static java11.net.http.HttpClient.Version.HTTP_1_1;
import static java11.net.http.HttpClient.Version.HTTP_2;
import static java11.net.http.HttpRequest.BodyPublishers.noBody;
import static java11.net.http.HttpRequest.BodyPublishers.ofString;
import static java11.net.http.HttpRequest.newBuilder;
...
public class RequestBuilderTest {
    ...
    public void testNull() {
        ...
        assertThrows(NPE, () -> builder.DELETE());
    ...
    public void testMethod() {
        ...
        request = newBuilder(uri).POST(ofString("")).GET().build();
        assertEquals(request.method(), "GET");
        assertTrue(!request.bodyPublisher().isPresent());

        request = newBuilder(uri).PUT(ofString("")).GET().build();
        assertEquals(request.method(), "GET");
        assertTrue(!request.bodyPublisher().isPresent());
        ...
        request = newBuilder(uri).POST(ofString("")).build();
        assertEquals(request.method(), "POST");
        assertTrue(request.bodyPublisher().isPresent());

        request = newBuilder(uri).PUT(ofString("")).build();
        ...
        request = newBuilder(uri).GET().POST(ofString("")).build();
        assertEquals(request.method(), "POST");
        assertTrue(request.bodyPublisher().isPresent());

        request = newBuilder(uri).GET().PUT(ofString("")).build();
        assertEquals(request.method(), "PUT");
        assertTrue(request.bodyPublisher().isPresent());
        ...
        request = newBuilder(uri).method("POST", ofString("")).build();
        assertEquals(request.method(), "POST");
        assertTrue(request.bodyPublisher().isPresent());
    }
    ...
    public void testEquals() {
        ...
        assertEquals(builder.build(), newBuilder(uri).POST(ofString("")).build());

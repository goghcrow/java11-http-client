...
import java11.util.concurrent.Flow.Publisher;
...
public class FlowAdapterPublisherTest {
    ...
    public void testAPIExceptions() {
        assertThrows(NPE, () -> HttpRequest.BodyPublishers.fromPublisher(null));
        assertThrows(NPE, () -> HttpRequest.BodyPublishers.fromPublisher(null, 1));
        assertThrows(IAE, () -> HttpRequest.BodyPublishers.fromPublisher(new BBPublisher(), 0));
        assertThrows(IAE, () -> HttpRequest.BodyPublishers.fromPublisher(new BBPublisher(), -1));
        assertThrows(IAE, () -> HttpRequest.BodyPublishers.fromPublisher(new BBPublisher(), Long.MIN_VALUE));

        Publisher publisher = HttpRequest.BodyPublishers.fromPublisher(new BBPublisher());
    ...
    void testByteBufferPublisherUnknownLength(String url) {
        ...
        HttpRequest request = HttpRequest.newBuilder(URI.create(url))
                .POST(HttpRequest.BodyPublishers.fromPublisher(new BBPublisher(body))).build();

        HttpResponse<String> response = client.sendAsync(request, HttpResponse.BodyHandlers.ofString(UTF_8)).join();
    ...
    void testByteBufferPublisherFixedLength(String url) {
        ...
        HttpClient client = HttpClient.newBuilder().sslContext(sslContext).build();
        HttpRequest request = HttpRequest.newBuilder(URI.create(url))
                .POST(HttpRequest.BodyPublishers.fromPublisher(new BBPublisher(body), cl)).build();
    ...
    void testMappedByteBufferPublisherUnknownLength(String url) {
        ...
        HttpClient client = HttpClient.newBuilder().sslContext(sslContext).build();
        HttpRequest request = HttpRequest.newBuilder(URI.create(url))
                .POST(HttpRequest.BodyPublishers.fromPublisher(new MBBPublisher(body))).build();
    ...
    void testMappedByteBufferPublisherFixedLength(String url) {
        ...
        HttpClient client = HttpClient.newBuilder().sslContext(sslContext).build();
        HttpRequest request = HttpRequest.newBuilder(URI.create(url))
                .POST(HttpRequest.BodyPublishers.fromPublisher(new MBBPublisher(body), cl)).build();

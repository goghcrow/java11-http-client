...
public class HttpResponseInputStreamTest {
    ...
    public static void testOnError() throws InterruptedException, ExecutionException {
        ...
        HttpResponse.BodySubscriber<InputStream> isb = HttpResponse.BodySubscribers.ofInputStream();
    ...
    static class ErrorTestSubscription implements Flow.Subscription {
        final HttpResponse.BodySubscriber<InputStream> isb;
        ...
        ErrorTestSubscription(HttpResponse.BodySubscriber<InputStream> isb) {
            this.isb = isb;
        }
            ...
            throws InterruptedException, ExecutionException
    {
        ...
        isb.onNext(java11.util.Lists.of(ByteBuffer.wrap("coucou".getBytes())));
        close(is);
        System.out.println(s);
        if (!s.cancelled.get()) {
            throw new RuntimeException("subscription not cancelled");

...
import jdk11.internal.net.http.HttpClientBuilderImpl;
import jdk11.internal.net.http.ProxySelectorEx;
 ...
 *
 * <p> A {@link HttpResponse.BodyHandler BodyHandler} must be supplied for each {@link
 ...
 * <ul>
 *     <li>{@link HttpClient#send(HttpRequest, HttpResponse.BodyHandler)} blocks
...
public abstract class HttpClient {
    ...
    public interface Builder {
         ...
         */
        public static final ProxySelector NO_PROXY = ProxySelectorEx.of(null);
         ...
         *
         * @apiNote {@link ProxySelectorEx#of(InetSocketAddress) ProxySelector::of}
         ...
         * one returned by {@link ProxySelectorEx#of(InetSocketAddress)
     ...
     *
     * <p> {@linkplain HttpResponse.PushPromiseHandler Push promises} received, if any, are

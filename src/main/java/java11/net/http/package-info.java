 ...
 *
 * <ul>
 *    <li>{@link java11.net.http.HttpClient}</li>
 *    <li>{@link java11.net.http.HttpRequest}</li>
 *    <li>{@link java11.net.http.HttpResponse}</li>
 *    <li>{@link java11.net.http.WebSocket}</li>
 * </ul>
 *
 ...
 * the operation, e.g. {@linkplain HttpClient#send(HttpRequest, HttpResponse.BodyHandler)

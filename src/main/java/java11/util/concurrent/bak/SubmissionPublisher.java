//package java11.util.concurrent.bak;
//
//
///**
// * 从 openjdk 迁移过来
// * http://hg.openjdk.java.net/jdk/jdk/file/a1aaf68b119d/src/java.base/share/classes/java/util/concurrent/SubmissionPublisher.java
// *
// * 迁移说明: by xiaofeng
// *
// * 1. @ jdk.internal.vm.annotation.Contended 替换为 @sun.misc.Contended
// * 这个注解是为了重排字段做内存对齐, 目的是为了消除缓存行的伪共享
// * BUT: 这个 @sun.misc.Contended 生效需要加启动参数!!!!!
// *
// * 2. 将 java.lang.invoke.VarHandle 全部处理成 Unsafe 实现, 心累
// */
//
//
...
//
//import static java11.util.concurrent.bak.Flow.*;
//
//
///**
...
//    static int roundCapacity(int cap) {
//        int n = cap - 1;
//        n |= n >>> 1;
//        n |= n >>> 2;
//        n |= n >>> 4;
...
//     */
//    @修改
//    // 因为 helpAsyncBlocker 注释掉了, 所以禁用 ForkJoinPool
...
//
//        @修改 Object ignored = null;
//        // 因为 helpAsyncBlocker 注释掉了, 所以禁用 ForkJoinPool
//        if (executor instanceof ForkJoinPool) {
//            throw new RuntimeException("不支持 FokrJoinPool");
//        }
//
...
//        @Override public final boolean exec() { consumer.consume(); return false; }
//        @Override public final void run() { consumer.consume(); }
//    }
//
//    /**
...
//            return UNSAFE.compareAndSwapInt(this, CTL_OFFSET, cmp, val);
//        }
//
//        final int getAndBitwiseOrCtl(int bits) {
//            @修改
//            // 参考 http://hg.openjdk.java.net/jdk/jdk/file/a1aaf68b119d/src/java.base/share/classes/java/lang/invoke/X-VarHandle.java.template#l238
//                    // 参考 http://hg.openjdk.java.net/jdk/jdk/file/a1aaf68b119d/src/java.base/share/classes/jdk/internal/misc/Unsafe.java#l3076
//                    // return (int)CTL.getAndBitwiseOr(this, bits);
//                    // 修改成这么一坨
//            /* start */
//                    int current;
//            do {
//                current = UNSAFE.getIntVolatile(this, CTL_OFFSET);
//            } while (!UNSAFE.compareAndSwapInt(this, CTL_OFFSET, current, current | bits));
//            return current;
//            /* end */
//        }
//
...
//            return n + UNSAFE.getAndAddLong(this, DEMAND_OFFSET, n);
//        }
//
//        @修改
//        final boolean casDemand(long cmp, long val) {
//            // return DEMAND.compareAndSet(this, cmp, val);
//            return UNSAFE.compareAndSwapLong(this, DEMAND_OFFSET, cmp, val);
//        }
//
...
//                    added = UNSAFE.compareAndSwapObject(a, QA_BASE_OFFSET + ((long)i << QA_SHIFT), null, item);
//                else {                             // can use release mode
//                    // @修改
//                    // 参考 http://hg.openjdk.java.net/jdk/jdk/file/a1aaf68b119d/src/java.base/share/classes/java/lang/invoke/X-VarHandle.java.template#l701
//                    // 参考 http://hg.openjdk.java.net/jdk/jdk/file/a1aaf68b119d/src/java.base/share/classes/jdk/internal/misc/Unsafe.java#l2105
//                    // QA.setRelease(a, i, item);
//                    UNSAFE.putObjectVolatile(a, QA_BASE_OFFSET + ((long)i << QA_SHIFT), item);
//                    added = true;
//                }
//                if (added) {
//                    tail = t + 1;
...
//                            Object x = UNSAFE.getAndSetObject(a, QA_BASE_OFFSET + ((long)(t & mask) << QA_SHIFT), null);
//
//                    if (x == null)
...
//
//                @修改 Object ignored = null;
//                // 参考: http://hg.openjdk.java.net/jdk/jdk/file/a1aaf68b119d/src/java.base/share/classes/java/lang/invoke/VarHandle.java#l2064
...
//            if ((a = array) != null && (cap = a.length) > 0 &&
//                    UNSAFE.compareAndSwapObject(a, QA_BASE_OFFSET + ((long)((cap - 1) & t) << QA_SHIFT), null, item))
//                stat = (tail = t + 1) - h;
//            return startOnOffer(stat);
//        }
//
...
//                            Object x = UNSAFE.getAndSetObject(a, QA_BASE_OFFSET + ((long)(h & m) << QA_SHIFT), null);
//                    if (waiting != 0)
//                        signalWaiter();
//                    if (x == null)
//                        break;
...
//            @修改
//            Object[] a; int cap;
//            // 参考 http://hg.openjdk.java.net/jdk/jdk/file/a1aaf68b119d/src/java.base/share/classes/java/lang/invoke/X-VarHandle.java.template#l690
//            // 参考 http://hg.openjdk.java.net/jdk/jdk/file/a1aaf68b119d/src/java.base/share/classes/jdk/internal/misc/Unsafe.java#l2041
////            return ((ctl & CLOSED) != 0 ||
////                    ((a = array) != null && (cap = a.length) > 0 &&
////                            QA.getAcquire(a, (cap - 1) & tail) == null));
//            return ((ctl & CLOSED) != 0 ||
//                    ((a = array) != null && (cap = a.length) > 0 &&
//                            UNSAFE.getObjectVolatile(a, QA_BASE_OFFSET + ((long)((cap - 1) & tail) << QA_SHIFT)) == null));
//        }
//
//        /**
...
//                // http://hg.openjdk.java.net/jdk/jdk/file/a1aaf68b119d/src/java.base/share/classes/java/util/concurrent/ForkJoinPool.java#l3132
//                // 源码只处理 ForkJoinPool, 修改起来太麻烦, 所以直接注释掉, 禁用掉 ForkJoinPool 功能
//
//                if (!isReleasable()) {
//                    timeout = nanos;
//                    try {
...
//        @修改 // 移除 VarHandle 添加 offset
//        static final long CTL_OFFSET;
//        static final long DEMAND_OFFSET;
//        static final int QA_BASE_OFFSET;
//        static final int QA_IDX_SCALE;
//        static final int QA_SHIFT;
//
//        @修改 // 添加
...
//
//            try {
//                UNSAFE = UnsafeAccessor.UNSAFE;
//                Field ctlField = BufferedSubscription.class.getDeclaredField("ctl");
//                Field demandField = BufferedSubscription.class.getDeclaredField("demand");
//
//                CTL_OFFSET = UNSAFE.objectFieldOffset(ctlField);
//                DEMAND_OFFSET = UNSAFE.objectFieldOffset(demandField);
//                QA_BASE_OFFSET = Unsafe.ARRAY_OBJECT_BASE_OFFSET;
//                QA_IDX_SCALE = Unsafe.ARRAY_OBJECT_INDEX_SCALE;
//                // QA_BASE_OFFSET = UNSAFE.arrayBaseOffset(Object[].class);
//                // QA_IDX_SCALE = UNSAFE.arrayIndexScale(Object[].class);
//                if ((QA_IDX_SCALE & (QA_IDX_SCALE - 1)) != 0) {
//                    throw new Error("data type scale not a power of two");
//                }
//                QA_SHIFT = 31 - Integer.numberOfLeadingZeros(QA_IDX_SCALE);
//
//            } catch (Exception e) {
//                throw new Error(e);
//            }

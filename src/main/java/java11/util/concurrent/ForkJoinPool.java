...
// CVS rev. 1.344
    ...
    /**
     * Factory for creating new {@link java11.util.concurrent.ForkJoinWorkerThread}s.
    ...
    public static interface ForkJoinWorkerThreadFactory {
         ...
         */
        public java11.util.concurrent.ForkJoinWorkerThread newThread(ForkJoinPool pool);
    }
...
//            new RuntimePermission("setContextClassLoader"), // java9-concurrent-backport changed
        ...
        public final java11.util.concurrent.ForkJoinWorkerThread newThread(ForkJoinPool pool) {
            return AccessController.doPrivileged(
                new PrivilegedAction<java11.util.concurrent.ForkJoinWorkerThread>() {
                    public java11.util.concurrent.ForkJoinWorkerThread run() {
                        return new java11.util.concurrent.ForkJoinWorkerThread(
    ...
    static final class WorkQueue {
        ...
        final java11.util.concurrent.ForkJoinWorkerThread owner; // owning thread or null if shared
        volatile Object pad10, pad11, pad12, pad13, pad14, pad15, pad16, pad17;
        volatile Object pad18, pad19, pad1a, pad1b, pad1c, pad1d, pad1e, pad1f;

        WorkQueue(ForkJoinPool pool, java11.util.concurrent.ForkJoinWorkerThread owner) {
            this.pool = pool;
            this.owner = owner;
    ...
    private boolean createWorker() {
        ...
        Throwable ex = null;
        java11.util.concurrent.ForkJoinWorkerThread wt = null;
        try {
     ...
     */
    final WorkQueue registerWorker(java11.util.concurrent.ForkJoinWorkerThread wt) {
     ...
     */
    final void deregisterWorker(java11.util.concurrent.ForkJoinWorkerThread wt, Throwable ex) {
        WorkQueue w = null;
        int phase = 0;
            ...
            for (int n = ws.length, j = n, m = n - 1; j > 0; --j) {
                ...
                if ((i = r & m) >= 0 && i < n &&        // always true
                    ...
                    if (t != null && b++ == q.base &&
                        ...
                        java11.util.concurrent.ForkJoinWorkerThread thread = w.owner;
                        ++w.nsteals;
                        w.source = 0;                   // now idle
                        if (thread != null)
    ...
    private <T> ForkJoinTask<T> externalSubmit(ForkJoinTask<T> task) {
        Thread t; java11.util.concurrent.ForkJoinWorkerThread w; WorkQueue q;
        Objects.requireNonNull(task);
        if (((t = Thread.currentThread()) instanceof java11.util.concurrent.ForkJoinWorkerThread) &&
            (w = (java11.util.concurrent.ForkJoinWorkerThread)t).pool == this &&
            (q = w.workQueue) != null)
            q.push(task);
        else
            externalPush(task);
    ...
    static int getSurplusQueuedTaskCount() {
        Thread t; java11.util.concurrent.ForkJoinWorkerThread wt; ForkJoinPool pool; WorkQueue q;
        if (((t = Thread.currentThread()) instanceof java11.util.concurrent.ForkJoinWorkerThread) &&
            (pool = (wt = (java11.util.concurrent.ForkJoinWorkerThread)t).pool) != null &&
            (q = wt.workQueue) != null) {
        ...
        while (((md = mode) & TERMINATED) == 0) { // help terminate others
            for (long oldSum = 0L;;) {            // repeat until stable
                ...
                if ((ws = workQueues) != null) {
                    for (int i = 0; i < ws.length; ++i) {
                        if ((w = ws[i]) != null) {
                            java11.util.concurrent.ForkJoinWorkerThread wt = w.owner;
    ...
    public boolean awaitQuiescence(long timeout, TimeUnit unit) {
        long nanos = unit.toNanos(timeout);
        java11.util.concurrent.ForkJoinWorkerThread wt;
        Thread thread = Thread.currentThread();
        if ((thread instanceof java11.util.concurrent.ForkJoinWorkerThread) &&
            (wt = (java11.util.concurrent.ForkJoinWorkerThread)thread).pool == this) {
    ...
    public static void managedBlock(ManagedBlocker blocker)
        ...
        if ((t instanceof java11.util.concurrent.ForkJoinWorkerThread) &&
            (p = (wt = (java11.util.concurrent.ForkJoinWorkerThread)t).pool) != null &&
            (w = wt.workQueue) != null) {
            int block;
            while (!blocker.isReleasable()) {
    ...
    static void helpAsyncBlocker(Executor e, ManagedBlocker blocker) {
        if (blocker != null && (e instanceof ForkJoinPool)) {
            WorkQueue w; java11.util.concurrent.ForkJoinWorkerThread wt; WorkQueue[] ws; int r, n;
            ForkJoinPool p = (ForkJoinPool)e;
            Thread thread = Thread.currentThread();
            if (thread instanceof java11.util.concurrent.ForkJoinWorkerThread &&
                (wt = (java11.util.concurrent.ForkJoinWorkerThread)thread).pool == p)
                w = wt.workQueue;

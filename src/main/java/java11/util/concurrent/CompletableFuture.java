 ...
 * value and status), and may be used as a {@link java11.util.concurrent.CompletionStage},
 ...
 * interface {@link java11.util.concurrent.CompletionStage} with the following policies: <ul>
 *
 ...
 * argument are performed using the {@link java11.util.concurrent.ForkJoinPool#commonPool()}
 ...
 * @since 1.8
 */
public class CompletableFuture<T> implements Future<T>, java11.util.concurrent.CompletionStage<T> {
// CVS rev. 1.212
    /*
     * Overview:
     *
    ...
    private static final boolean USE_COMMON_POOL =
        (java11.util.concurrent.ForkJoinPool.getCommonPoolParallelism() > 1);
    ...
    private static final Executor ASYNC_POOL = USE_COMMON_POOL ?
        java11.util.concurrent.ForkJoinPool.commonPool() : new ThreadPerTaskExecutor();
    ...
    static Executor screenExecutor(Executor e) {
        if (!USE_COMMON_POOL && e == java11.util.concurrent.ForkJoinPool.commonPool())
            return ASYNC_POOL;
    ...
    abstract static class Completion extends java11.util.concurrent.ForkJoinTask<Void>
    ...
    static final class UniCompose<T,V> extends UniCompletion<T,V> {
        Function<? super T, ? extends java11.util.concurrent.CompletionStage<V>> fn;
        ...
        final CompletableFuture<V> tryFire(int mode) {
            CompletableFuture<V> d; CompletableFuture<T> a;
            Function<? super T, ? extends java11.util.concurrent.CompletionStage<V>> f;
    ...
    private <V> CompletableFuture<V> uniComposeStage(
        Executor e, Function<? super T, ? extends java11.util.concurrent.CompletionStage<V>> f) {
        Objects.requireNonNull(f);
        CompletableFuture<V> d = newIncompleteFuture();
    ...
    private <U,V> CompletableFuture<V> biApplyStage(
        Executor e, java11.util.concurrent.CompletionStage<U> o,
    ...
    private CompletableFuture<Void> biRunStage(Executor e,
                                               java11.util.concurrent.CompletionStage<?> o, Runnable f) {
        CompletableFuture<?> b;
        Object r, s;
        if (f == null || (b = o.toCompletableFuture()) == null)
            throw new NullPointerException();
    ...
    private <U extends T,V> CompletableFuture<V> orApplyStage(
            Executor e, java11.util.concurrent.CompletionStage<U> o, Function<? super T, ? extends V> f) {
        CompletableFuture<U> b;
        if (f == null || (b = o.toCompletableFuture()) == null)
            throw new NullPointerException();
    ...
    private <U extends T> CompletableFuture<Void> orAcceptStage(
            Executor e, java11.util.concurrent.CompletionStage<U> o, Consumer<? super T> f) {
        CompletableFuture<U> b;
        if (f == null || (b = o.toCompletableFuture()) == null)
            throw new NullPointerException();
    ...
    @SuppressWarnings("serial")
    static final class AsyncSupply<T> extends java11.util.concurrent.ForkJoinTask<Void>
        implements Runnable, AsynchronousCompletionTask {
    ...
    @SuppressWarnings("serial")
    static final class AsyncRun extends java11.util.concurrent.ForkJoinTask<Void>
        implements Runnable, AsynchronousCompletionTask {
    ...
    static final class Signaller extends Completion
        implements java11.util.concurrent.ForkJoinPool.ManagedBlocker {
    ...
    private Object waitingGet(boolean interruptible) {
        ...
        while ((r = result) == null) {
            if (q == null) {
                ...
                if (Thread.currentThread() instanceof java11.util.concurrent.ForkJoinWorkerThread)
                    java11.util.concurrent.ForkJoinPool.helpAsyncBlocker(defaultExecutor(), q);
            }
            else if (!queued)
                queued = tryPushStack(q);
            else {
                try {
                    java11.util.concurrent.ForkJoinPool.managedBlock(q);
     ...
     * by a task running in the {@link java11.util.concurrent.ForkJoinPool#commonPool()} with
    ...
    /**
     * Returns a new CompletableFuture that is asynchronously completed
     * by a task running in the {@link java11.util.concurrent.ForkJoinPool#commonPool()} after
    ...
    public <U,V> CompletableFuture<V> thenCombine(
        java11.util.concurrent.CompletionStage<? extends U> other,
        BiFunction<? super T,? super U,? extends V> fn) {
    ...
    public CompletableFuture<Void> runAfterBoth(java11.util.concurrent.CompletionStage<?> other,
                                                Runnable action) {
        return biRunStage(null, other, action);
    }

    public CompletableFuture<Void> runAfterBothAsync(java11.util.concurrent.CompletionStage<?> other,
                                                     Runnable action) {
    ...
    public <U> CompletableFuture<U> applyToEither(
            java11.util.concurrent.CompletionStage<? extends T> other, Function<? super T, U> fn) {
    ...
    public CompletableFuture<Void> acceptEither(
            java11.util.concurrent.CompletionStage<? extends T> other, Consumer<? super T> action) {
    ...
    public CompletableFuture<Void> runAfterEither(java11.util.concurrent.CompletionStage<?> other,
                                                  Runnable action) {
        return orRunStage(null, other, action);
    }

    public CompletableFuture<Void> runAfterEitherAsync(java11.util.concurrent.CompletionStage<?> other,
                                                       Runnable action) {
    ...
    public <U> CompletableFuture<U> thenCompose(
        Function<? super T, ? extends java11.util.concurrent.CompletionStage<U>> fn) {
     ...
     * java11.util.concurrent.ForkJoinPool#commonPool()} if it supports more than one
     ...
     * java11.util.concurrent.CompletionStage}.  If this CompletableFuture completes
     ...
     * @since 9
     */
    public java11.util.concurrent.CompletionStage<T> minimalCompletionStage() {
     ...
     * interface {@link java11.util.concurrent.CompletionStage}.
     *
     * @param value the value
     * @param <U> the type of the value
     ...
     * @since 9
     */
    public static <U> java11.util.concurrent.CompletionStage<U> completedStage(U value) {
     ...
     * methods in interface {@link java11.util.concurrent.CompletionStage}.
     *
     * @param ex the exception
     * @param <U> the type of the value
     ...
     * @since 9
     */
    public static <U> java11.util.concurrent.CompletionStage<U> failedStage(Throwable ex) {

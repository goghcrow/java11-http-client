 ...
 * questions.
 */
package jdk11.internal.net.http.hpack;

import java11.util.Maps;
import jdk11.internal.net.http.common.Utils;
import jdk11.internal.net.http.hpack.HPACK.Logger.Level;
...
import static jdk11.internal.net.http.hpack.HPACK.Logger.Level.EXTRA;
import static jdk11.internal.net.http.hpack.HPACK.Logger.Level.NONE;
import static jdk11.internal.net.http.hpack.HPACK.Logger.Level.NORMAL;
...
public final class HPACK {
    ...
    static {
        ...
        if (value == null) {
            ...
            if (l == null) {
                LOGGER = new RootLogger(NONE);
                LOGGER.log(java11.lang.System.Logger.Level.INFO,
                ...
                LOGGER.log(java11.lang.System.Logger.Level.DEBUG,
                        () -> String.format("logging level %s", l));
            }
        }
    }
    ...
    public static class Logger implements java11.lang.System.Logger {
        ...
        public enum Level {
            ...
            NONE(0, java11.lang.System.Logger.Level.OFF),
            NORMAL(1, java11.lang.System.Logger.Level.DEBUG),
            EXTRA(2, java11.lang.System.Logger.Level.TRACE);

            private final int level;
            final java11.lang.System.Logger.Level systemLevel;

            Level(int i, java11.lang.System.Logger.Level system) {
                level = i;
                systemLevel = system;
            }
        ...
        private final java11.lang.System.Logger logger;

        private Logger(String path, String name, Level level) {
            this(path, name, level, null);
        }

        private Logger(String p, String name, Level level, java11.lang.System.Logger logger) {
            this.path = p;
            this.name = name;
            this.level = level;
        ...
        @Override
        public boolean isLoggable(java11.lang.System.Logger.Level level) {
            return logger.isLoggable(level);
        }

        @Override
        public void log(java11.lang.System.Logger.Level level, ResourceBundle bundle, String msg, Throwable thrown) {
            logger.log(level, bundle, msg,thrown);
        }

        @Override
        public void log(java11.lang.System.Logger.Level level, ResourceBundle bundle, String format, Object... params) {

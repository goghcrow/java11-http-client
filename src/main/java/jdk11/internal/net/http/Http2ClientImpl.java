...
class Http2ClientImpl {
    ...
    int getConnectionWindowSize(SettingsFrame clientSettings) {
        ...
        int streamWindow = clientSettings.getParameter(SettingsFrame.INITIAL_WINDOW_SIZE);
    ...
    SettingsFrame getClientSettings() {
        ...
        frame.setParameter(SettingsFrame.HEADER_TABLE_SIZE, getParameter(
                "jdk.httpclient.hpack.maxheadertablesize",
                0, Integer.MAX_VALUE, 16 * K));
        // O: does not accept push streams. 1: accepts push streams.
        frame.setParameter(SettingsFrame.ENABLE_PUSH, getParameter(
        ...
        frame.setParameter(SettingsFrame.MAX_CONCURRENT_STREAMS, getParameter(
        ...
        frame.setParameter(SettingsFrame.INITIAL_WINDOW_SIZE, getParameter(
        ...
        frame.setParameter(SettingsFrame.MAX_FRAME_SIZE, getParameter(

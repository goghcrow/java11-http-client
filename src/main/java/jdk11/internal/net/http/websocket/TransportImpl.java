...
import jdk11.internal.net.http.common.SequentialScheduler.CompleteRestartableTask;
...
import static jdk11.internal.net.http.websocket.TransportImpl.ChannelState.AVAILABLE;
import static jdk11.internal.net.http.websocket.TransportImpl.ChannelState.CLOSED;
import static jdk11.internal.net.http.websocket.TransportImpl.ChannelState.UNREGISTERED;
import static jdk11.internal.net.http.websocket.TransportImpl.ChannelState.WAITING;
...
public class TransportImpl implements Transport {
    ...
    private final ByteBuffer dst = ((ByteBuffer) createWriteBuffer().position(0).limit(0));

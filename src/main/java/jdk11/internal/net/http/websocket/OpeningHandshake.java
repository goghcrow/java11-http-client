...
import java11.net.http.HttpClient.Version;
import java11.net.http.HttpHeaders;
import java11.net.http.HttpResponse;
import java11.net.http.HttpResponse.BodyHandlers;
import java11.net.http.WebSocketHandshakeException;

import java11.util.Lists;
import jdk11.internal.net.http.HttpRequestBuilderImpl;
import jdk11.internal.net.http.HttpRequestImpl;
import jdk11.internal.net.http.common.MinimalFuture;
import jdk11.internal.net.http.common.Pair;
...
import static jdk11.internal.net.http.common.Utils.isValidName;
import static jdk11.internal.net.http.common.Utils.permissionForProxy;
import static jdk11.internal.net.http.common.Utils.stringOf;

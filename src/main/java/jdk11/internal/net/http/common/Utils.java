...
package jdk11.internal.net.http.common;

import java11.util.Lists;
import java11.util.Sets;
import jdk11.internal.net.http.hack.SSLParametersEx;
import jdk11.internal.net.http.common.hack.HackUtils;
...
import java11.net.http.HttpTimeoutException;
...
public final class Utils {
    private static final boolean IS_JAVA8 = HackUtils.isJava8();
...
//    }
    ...
    static {
        ...
        treeSet.addAll(Sets.of("connection", "content-length",
    ...
    static {
        ...
        PROXY_AUTH_DISABLED_SCHEMES =
                proxyAuthDisabled == null ? Sets.of() :
                        Stream.of(proxyAuthDisabled.split(","))
                                .map(String::trim)
                                .filter((s) -> !s.isEmpty())
                                .collect(java11.util.stream.Collectors.toUnmodifiableSet());
        PROXY_AUTH_TUNNEL_DISABLED_SCHEMES =
                proxyAuthTunnelDisabled == null ? Sets.of() :
    ...
    public static SSLParameters copySSLParameters(SSLParameters p) {
        ...
        if (!IS_JAVA8) {
            ...
            SSLParametersEx.setEnableRetransmissions(p1, SSLParametersEx.getEnableRetransmissions(p));
            SSLParametersEx.setMaximumPacketSize(p1, SSLParametersEx.getMaximumPacketSize(p));
        }
        // JDK 8 EXCL END

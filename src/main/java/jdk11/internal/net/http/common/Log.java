...
// information
public abstract class Log implements java11.lang.System.Logger {
    ...
    static final java11.lang.System.Logger logger;
    ...
    static {
        ...
        if (logging != OFF) {
            logger = java11.lang.System.getLogger("jdk.httpclient.HttpClient");
        } else {
            logger = null;
        }
    }
    ...
    public static void logParams(SSLParametersEx p) {
        if (!Log.ssl()) {
            return;
        }

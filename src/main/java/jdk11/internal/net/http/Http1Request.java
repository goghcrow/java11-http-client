...
import jdk11.internal.net.http.common.HttpHeadersBuilder;
...
class Http1Request {
    ...
    Http1Exchange.Http1BodySubscriber continueRequest()  {
        Http1Exchange.Http1BodySubscriber subscriber;
        if (streaming) {
    ...
    final class StreamSubscriber extends Http1Exchange.Http1BodySubscriber {
    ...
    final class FixedContentSubscriber extends Http1Exchange.Http1BodySubscriber {

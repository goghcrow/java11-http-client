 ...
 */
package jdk11.internal.net.http.hack;
 ...
 * methods in addition.
 */
public final class SSLParametersEx {
    ...
    public static void setEnableRetransmissions(SSLParameters params, boolean enableRetransmissions) {
        try {
    ...
    public static boolean getEnableRetransmissions(SSLParameters params) {
        try {
    ...
    public static void setMaximumPacketSize(SSLParameters params, int maximumPacketSize) {
        try {
    ...
    public static int getMaximumPacketSize(SSLParameters params) {
        try {
    ...
    public static String[] getApplicationProtocols(SSLParameters params) {
        try {
